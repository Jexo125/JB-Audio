...
class LibrarySearchDelegate extends SearchDelegate<String> {
  ...
  LibrarySearchDelegate({required this.libraryProvider, required this.isDark, required this.context})
    : super(
        searchFieldLabel: AppLocalizations.of(context)!.searchLibraryHint,
      ...
      children: [
        ...
        ...matchingPlaylists.map(
          (playlist) => ListTile(
            ...
            subtitle: Text(l10n.songsCount(playlist.songCount ?? 0)),
            onTap: () {
              close(context, '');
