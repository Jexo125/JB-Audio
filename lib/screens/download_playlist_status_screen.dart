...
class DownloadPlaylistStatusScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.playlistDownloads),
        leading: IconButton(
      ...
      body: ValueListenableBuilder<Set<String>>(
        ...
        builder: (context, ids, _) {
          if (playlists.isEmpty) {
            return Center(child: Text(AppLocalizations.of(context)!.noPlaylistsFound));
          }
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: hasSongs
                    ...
                    : Text(
                        AppLocalizations.of(context)!.songsCount(total),
                        style: TextStyle(
                          fontSize: 13,
