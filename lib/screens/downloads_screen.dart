...
class _DownloadsScreenState extends State<DownloadsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.downloadedSongs),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(AppLocalizations.of(context)!.noDownloadedSongs),
          ],
        ),
      );
    }
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(AppLocalizations.of(context)!.noDownloadedAlbums),
          ],
        ),
      );
    }
