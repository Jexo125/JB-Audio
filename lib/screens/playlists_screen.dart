          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(AppLocalizations.of(context)!.noPlaylistsFound, style: theme.textTheme.headlineMedium),
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          autofocus: true,
          decoration: InputDecoration(hintText: AppLocalizations.of(context)!.playlistNameHint),
        ),
        actions: [
          TextButton(
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () async {
                  Navigator.pop(context);
                  OfflineService().cancelPlaylistDownload(playlist.id);
