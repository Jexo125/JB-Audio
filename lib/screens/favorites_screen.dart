...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.categoryFavorites),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return SongTile(
          ...
          showAlbum: true,
          onLongPress: () =>
              _showRemoveFromFavoritesDialog(context, song, index, l10n),
        );
      },
    );
  }
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  await _removeFromFavorites(song, index, l10n);
                },
              ),
              const SizedBox(height: 16),
            ],
  ...
  Future<void> _removeFromFavorites(Song song, int index, AppLocalizations l10n) async {
    final subsonicService = Provider.of<SubsonicService>(
      context,
      listen: false,
    );
  ...
  Widget _buildAlbumsList(AppLocalizations l10n) {
