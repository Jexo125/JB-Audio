...
class _AlbumScreenState extends State<AlbumScreen> {
  ...
  Future<void> _downloadAlbum() async {
    ...
    await offlineService.queuePlaylistDownload(_album!.id, _songs, subsonicService);
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context)!.queuedSongsForDownload(_songs.length)),
  ...
  Future<void> _cancelDownload() async {
    ...
    OfflineService().cancelPlaylistDownload(_album!.id);
  }
  ...
  Future<void> _removeDownloads() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(AppLocalizations.of(context)!.removeDownloadsConfirm(_songs.length, _album!.name)),
        actions: [
    ...
    if (confirmed == true && mounted) {
      OfflineService().cancelPlaylistDownload(_album!.id);
      await OfflineService().deletePlaylistDownloads(_album!.id, _songs);
    }
  }
