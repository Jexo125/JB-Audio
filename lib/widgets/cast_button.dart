              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      isFr ? 'Recherche d\'appareils...' : 'Searching devices...',
                      style: const TextStyle(fontSize: 16),
                    ),
                    const SizedBox(height: 8),
                    Text(
                      isFr
                          ? 'Assurez-vous que votre appareil est connecté au même réseau Wi-Fi.'
                        ...
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                ok
                                    ? (isFr ? "Connecté à ${d.friendlyName}" : "Connected to ${d.friendlyName}")
                                    : (isFr ? "Échec de la connexion à ${d.friendlyName}" : "Failed to connect to ${d.friendlyName}"),
                              ),
