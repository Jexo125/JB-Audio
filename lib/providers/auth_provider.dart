...
class AuthProvider extends ChangeNotifier {
  ...
  Future<void> _verifyConnection() async {
    ...
    PingResult pingResult = PingResult(success: false, error: 'Not initialized');
    const maxAttempts = 3;
    ...
    for (int attempt = 1; attempt <= maxAttempts; attempt++) {
      try {
        ...
        pingResult = PingResult(success: false, error: 'Connection timed out');
      } catch (e) {
        pingResult = PingResult(success: false, error: e.toString());
      }
