...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Enable LRCLIB Fallback'**
  String get enableLrcLibFallback;

  /// Subtitle explaining the LRCLIB fallback toggle
  ///
  /// In en, this message translates to:
  /// **'Fetch lyrics automatically from LRCLIB when unavailable on server'**
  ...
  /// No description provided for @autoDjOff.
  ///
  /// In en, this message translates to:
  /// **'Off'**
  String get autoDjOff;

  /// No description provided for @autoDjShuffleLibrary.
  ///
  /// In en, this message translates to:
  /// **'Shuffle Library'**
  String get autoDjShuffleLibrary;

  /// No description provided for @autoDjSimilarSongs.
  ///
  /// In en, this message translates to:
  /// **'Similar Songs'**
  String get autoDjSimilarSongs;

  /// No description provided for @autoDjSameGenre.
  ///
  /// In en, this message translates to:
  /// **'Same Genre'**
  String get autoDjSameGenre;

  /// No description provided for @autoDjSameArtist.
  ///
  /// In en, this message translates to:
  /// **'Same Artist'**
  String get autoDjSameArtist;

  /// No description provided for @autoDjSmartMix.
  ///
  /// In en, this message translates to:
  /// **'Smart Mix'**
  String get autoDjSmartMix;

  /// No description provided for @fetchLyricsDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @noDownloadsInProgress.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @songsDownloaded.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @genreChristian.
  ///
  /// In en, this message translates to:
  /// **'Christian'**
  String get genreChristian;
  ...
  /// No description provided for @genreNewAge.
  ///
  /// In en, this message translates to:
  /// **'New Age'**
  String get genreNewAge;
  ...
  /// No description provided for @genreTrance.
  ///
  /// In en, this message translates to:
  /// **'Trance'**
  String get genreTrance;
  ...
  /// No description provided for @noNewReleases.
  ///
  /// In en, this message translates to:
  /// **'No new releases'**
  ...
  /// No description provided for @noDownloadedAlbums.
  ///
  /// In en, this message translates to:
  /// **'No downloaded albums'**
  String get noDownloadedAlbums;
  ...
  ///
  /// In en, this message translates to:
  /// **'Connection is taking a while...'**
  String get connectionSlow;

  /// No description provided for @removeDownloadsTitle.
  ///
  /// In en, this message translates to:
  /// **'Remove downloads?'**
  String get removeDownloadsTitle;

  /// No description provided for @removeDownloadsConfirm.
  ///
  /// In en, this message translates to:
  /// **'Remove all {count} downloaded songs from \"{name}\"?'**
  String removeDownloadsConfirm(int count, String name);

  /// No description provided for @removeSongsTitle.
  ///
  /// In en, this message translates to:
  /// **'Remove songs'**
  String get removeSongsTitle;

  /// No description provided for @removeSongsConfirm.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Remove 1 song from this playlist?} other{Remove {count} songs from this playlist?}}'**
  ...
  /// No description provided for @songRemovedPlaylist.
  ///
  /// In en, this message translates to:
  /// **'Song removed from playlist'**
  String get songRemovedPlaylist;

  /// No description provided for @songsRemovedPlaylist.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 song removed from playlist} other{{count} songs removed from playlist}}'**
  ...
  /// No description provided for @doneReordering.
  ///
  /// In en, this message translates to:
  /// **'Done reordering'**
  ...
  /// No description provided for @wordByWordSync.
  ///
  /// In en, this message translates to:
  /// **'Word-by-Word Sync'**
  String get wordByWordSync;

  /// No description provided for @wordByWordSyncSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Analyzes audio locally with Whisper AI for precise word highlighting'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Download a model for on-device speech recognition'**
  ...
  /// No description provided for @whisperModelBase.
  ///
  /// In en, this message translates to:
  /// **'Base (~140 MB) — Balanced'**
  String get whisperModelBase;

  /// No description provided for @whisperModelSmall.
  ///
  /// In en, this message translates to:
  /// **'Small (~470 MB) — Accurate'**
  ...
  /// No description provided for @wordSyncProcessing.
  ///
  /// In en, this message translates to:
  /// **'Syncing words…'**
  String get wordSyncProcessing;

  /// No description provided for @wordSyncClearCache.
  ///
  /// In en, this message translates to:
  /// **'Clear Word Sync Cache'**
  String get wordSyncClearCache;

  /// No description provided for @wordSyncClearCacheSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Removes locally stored word timestamps'**
  String get wordSyncClearCacheSubtitle;

  /// No description provided for @wordSyncNotSupported.
  ///
  /// In en, this message translates to:
  /// **'Not supported on this platform'**
  String get wordSyncNotSupported;

  /// No description provided for @queuedSongsForDownload.
  ///
  /// In en, this message translates to:
  /// **'Queued {count} songs for download…'**
  String queuedSongsForDownload(int count);

  /// No description provided for @downloadedTooltip.
  ///
  /// In en, this message translates to:
  /// **'Downloaded — tap to remove'**
  String get downloadedTooltip;

  /// No description provided for @downloadingTooltip.
  ///
  /// In en, this message translates to:
  /// **'Downloading — tap to cancel'**
  String get downloadingTooltip;
